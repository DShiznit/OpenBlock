...
vehicleMap.bind(gamepad0, "thumblx", D, "-0.23 0.23", gamepadYaw);
vehicleMap.bind(gamepad0, "btn_a", moveForward);
vehicleMap.bind(gamepad0, "btn_b", brake);
vehicleMap.bind(gamepad0, "btn_x", movebackward);
vehicleMap.bindCmd(gamepad0, "btn_y", "getout();", "");
